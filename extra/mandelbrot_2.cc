...
Nx=25;  //total number of y nodes
Ny=25;  //total number of x nodes
...
ofstream fout("mandelbrot_set_3.ppm");    //using ppm for plotting, 
...
//cout<< "dx is : " << dx ;       //test 
//cout << "\ndy is :  " << dy;    //test
int count = 0;     //count for calculating area
